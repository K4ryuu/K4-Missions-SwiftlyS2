...
[PluginMetadata(Id = "k4.missions", Version = "1.0.0", Name = "K4 - Missions", Author = "K4ryuu", Description = "A dynamic mission system for Counter-Strike 2 using SwiftlyS2 framework.")]
